...
public:
    ...
    /*!
     * @brief Constructor.
     * @param[in] useGPU  If true then the picker will be initialized to use
     *                    the CUDA-based GPU if it is available.
     */
    Model();//bool useGPU = false);
    /*! @} */
     ...
     */
    int getMinimumSeismogramLength() const noexcept;
    /*!
     ...
     */
    bool isValidSeismogramLength(int nSamples) const noexcept;
    /*!
