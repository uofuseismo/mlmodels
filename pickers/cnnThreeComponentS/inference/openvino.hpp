...
#include "../../../detectors/uNetThreeComponentP/inference/utilities.hpp"
#define MODEL_NAME "SCNNNet"
namespace
{
...
void createFinalLayer(
    ...
    const double minPerturbation =-0.85,
    const double maxPerturbation = 0.85
)
{
#ifndef NDEBUG
...
public:
    OpenVINOImpl(
        ...
        double mMinPerturbation =-0.85,
        double mMaxPerturbation = 0.85)
    {
